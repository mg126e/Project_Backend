running 6 tests from ./src/concepts/PartnerMatching/PartnerMatching.test.ts
...
--- Test: suggestMatch Action Requirements ---
 ...
 > Testing: Cannot create the same suggestion twice.
   ✅ Correctly failed.
----- output end -----
PartnerMatching: suggestMatch action requirements ... ok (807ms)
...
----- output end -----
PartnerMatching: Scenario - Declining a Suggestion ... ok (883ms)
...
----- output end -----
PartnerMatching: Scenario - Accepting a Non-Pending Suggestion ... ok (809ms)
...
----- output end -----
PartnerMatching: unmatch action requirements ... ok (613ms)
...
----- output end -----
PartnerMatching: updateProfilePreferences action ... ok (635ms)
